...
const DisplayErrorMessage = ({
  ...
  }, [errorMessage, autoClose, autoCloseDelay, setErrorMessage]);
  ...
  return (
    <div
      className={`flex items-start justify-between p-4 mb-4 rounded-lg border ${typeStyles[type]} animate-in fade-in slide-in-from-top-2 duration-300`}
      role="alert"
    >
